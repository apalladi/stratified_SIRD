...
def deriv_stratified_SIRD(y, t, N, beta0, gamma, tau, fatality_rates_perc):
    ...
    return dS1dt, dS2dt, dS3dt, dS4dt, dI1dt, dI2dt, dI3dt, dI4dt, dR1dt, dR2dt, dR3dt, dR4dt, dD1dt, dD2dt, dD3dt, dD4dt

def stratified_SIRD(beta0, gamma, tau, fatality_rates_perc, N, I0, R0, D0, t=np.arange(0, 720)):
    ...
    S10 = N[0]- I0[0] - R0[0] - D0[0] # number of people that can still contract the virus
    S20 = N[1]- I0[1] - R0[1] - D0[1]
    S30 = N[2]- I0[2] - R0[2] - D0[2]
    S40 = N[3]- I0[3] - R0[3] - D0[3]

    # Initial conditions vector
    y0 = S10, S20, S30, S40, I0[0], I0[1], I0[2], I0[3], R0[0], R0[1], R0[2], R0[3], D0[0], D0[1], D0[2], D0[3]
 
    # Integrate the SIR equations over the time grid, t.
    ret = odeint(deriv_stratified_SIRD, y0, t, args=(N, beta0, gamma, tau, fatality_rates_perc))
